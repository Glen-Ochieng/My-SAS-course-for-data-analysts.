...
# The next method invloves using the firstobs and obs. Here you hand pick the exact rows in your sub-dataset whereby firstobs=Beginning row index and obs =Last row index. All columns are brought back.;
